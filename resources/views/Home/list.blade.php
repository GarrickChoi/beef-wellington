	                  	...
	                  	<div class="theme-popover">														
							<ul class="select">
								...
								<li class="select-list">
									<dl>
										<dt class="am-badge am-round">品牌</dt>	
										 <div class="dd-conent">										
											<dd class="{{empty($bid)?'select-all selected':''}}"><a href="{{url('Home/list?pid='.$pid.'&id='.$id)}}">全部</a></dd>
									@foreach($brands as $v)
											<dd class=" {{$v->id == $bid?'selected':''}} "><a href="{{url('Home/list?pid='.$pid.'&id='.$id.'&bid='.$v->id)}}">{{$v->name}}</a></dd>
									@endforeach
										 </div>
									</dl>
								</li>
								<li class="select-list">
									<dl>
										...
										<div class="dd-conent">
											<dd class="{{empty($id)?'select-all selected':''}}"><a href="{{url('Home/list?pid='.$pid.'&bid='.$bid)}}">全部</a></dd>
											@foreach($sonTypes as $v)
											<dd class=" {{$v->id == $id?'selected':''}} "><a href="{{url('Home/list?pid='.$v->pid.'&id='.$v->id.'&bid='.$bid)}}">{{$v->name}}</a></dd>
											@endforeach
										</div>
									</dl>
								</li>					        
							...
							<div class="search-content">
								<div class="sort">
									...
									<a title="综合" href="{{url('Home/list?pid='.$pid.'&bid='.$bid.'&id='.$id)}}">
									...
									<a title="人气" href="{{url('Home/list?pid='.$pid.'&bid='.$bid.'&id='.$id.'&rank_name='.'clicknum'.'&rank='.'desc')}}">
									...
									<a title="销量" href="{{url('Home/list?pid='.$pid.'&bid='.$bid.'&id='.$id.'&rank_name='.'buynum'.'&rank='.'desc')}}">
									@if ($rank_name == 'buynum')
									...
									<li class="{{$rank_name == 'price'?'first':''}}" style=" width:180px">
											<a title="价格" href="{{url('Home/list?pid='.$pid.'&bid='.$bid.'&id='.$id.'&rank_name='.'price'.'&rank='.$rank)}}">
							...
							<ul class="page">
								...
								{{ $goods->appends(['pid' => $pid, 'id' => $id, 'bid' => $bid])->links() }}
