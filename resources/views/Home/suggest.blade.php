...
<html>
	...
	<head>
		...
		<script src="{{asset('Home/js/amazeui.min.js')}}" type="text/javascript"></script>
					...
					<div class="suggestmain">
						...
						<div class="suggestlist">
							<select data-am-selected  name="type">
								<option value="" selected>请选择意见类型</option>
						...
						<div class="suggestDetail">
							...
							<blockquote class="textArea">
								<textarea name="question" id="say_some" cols="60" rows="5" autocomplete="off" placeholder="在此描述您的意见具体内容"></textarea>
								<div class="fontTip"></div>
							</blockquote>
						</div>
						
							<button class="am-btn am-btn-danger am-round anniu" type="submit">提交</button>
						
						</form>
						<p class="suggestTel"><i class="am-icon-phone"></i>客服电话：12345</p>
					</div>
				</div>
				<!--底部-->
				<div class="footer">
