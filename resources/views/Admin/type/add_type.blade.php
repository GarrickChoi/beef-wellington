...
<html>
  ...
  <body>
    <div class="x-body" style="diaplay:inline-block;">
        <form method="post" action="{{url('addTopLevelType')}}" enctype="multipart/form-data" style="diaplay:inline-block;">
          <div class="layui-form-item" style="diaplay:inline-block;">
              <label for="name" class="layui-form-label">
                  <span class="x-red">*</span>顶级分类
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="name" name="name" required="" placeholder="顶级分类名" lay-verify="required"
