...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="{{url('type')}}"  title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
    </div>
    <div class="x-body">
      <div class="layui-row">
        <form action="{{url('type')}}" method="get" class="layui-form layui-col-md12 x-so layui-form-pane">
          <input class="layui-input" placeholder="分类名/分类ID" name="type_info" value="">
      ...
      <xblock>
        ...
        <a class="layui-btn layui-btn-normal" href="{{url('restoreT')}}"><i class="layui-icon"></i>  批量恢复</a>
        <a class="layui-btn" href="{{url('addType')}}" title="添加顶级分类"><i class="layui-icon"></i> 增加</a>
        <span class="x-right" style="line-height:40px">本页数据：{{ $allTypes->count() }} 条</span>
      </xblock>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="添加子分类" href="{{url('addBranch',[$v->id])}}">
                <i class="layui-icon"></i><font color="rgb(24,159,146)">添加子分类</font>
              </a>
      ...
      <div class="page">
          {{ $allTypes->appends(['searchInfo' => $searchInfo])->links() }}
      </div>
              ...
              $.ajax({
                  ...
                  success:function(data) {
                    ...
                    if (data.code == "2444") {
                        ...
                        layer.msg('失败，分类下有分支或无效操作!',{icon:2,time:1000});
