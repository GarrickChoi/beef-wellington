...
<link href="{{asset('Admin/css/one.css')}}" rel="stylesheet">

<script src="{{asset('Admin/js/one.js')}}"></script>
<script src="{{asset('Admin/js/two.js')}}"></script>
<script src="{{asset('Admin/js/three.js')}}"></script>
