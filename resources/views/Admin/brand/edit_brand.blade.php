  ...
  <body>
    <div class="x-body" style="diaplay:inline-block;">
        <form method="post" action="{{url('doEditBS')}}" enctype="multipart/form-data" style="diaplay:inline-block;">
          <input type="hidden" name="bid" value="{{$binfo->id}}">
          <input type="hidden" name="os" value="{{$binfo->status}}">
          <div class="layui-form-item" style="diaplay:inline-block;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" value="{{$binfo->name}}" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item" style="diaplay:inline-block;">
              ...
              <div style="display:inline-block">
                <select name="status">
                  @foreach($allStatus as $v)
                    <option value="{{$v->id}}" <?= $binfo->status == $v->id? 'selected':''?> >{{$v->name}}</option>
                  @endforeach
                </select>
              </div>
          </div>
          ...
          <div class="layui-form-item" style="diaplay:inline-block;">
              ...
              <form style="diaplay:inline-block;">
                <a href="{{url('skipFace',[$binfo->status])}}" class="layui-btn">
                      返回
                </a>
              </form>
          </div>
