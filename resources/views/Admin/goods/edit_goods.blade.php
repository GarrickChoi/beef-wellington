...
<html>
  ...
  <div class="x-body">
    ...
    @endif
    <div class="x-body">
        <form class="layui-form" action="{{url('editGoodsInfo')}}" method="post" enctype="multipart/form-data">
          <input type="hidden" name="gid" value="{{$goodsInfo[0]->id}}}">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="{{$goodsInfo[0]->name}}">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="brand" name="brand" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $allAttributes['brand'][0]->id?'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="type" name="type" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $allAttributes['type'][0]->id?'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="color" name="color" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $allAttributes['colors'][0]->id?'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="ingredient" name="ingredient" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $allAttributes['ingredient'][0]->id?'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="market" name="market" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $allAttributes['market'][0]->id?'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="Basic_style" name="Basic_style" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $allAttributes['style'][0]->id?'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="season" name="season" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $allAttributes['season'][0]->id?'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="objects" name="objects" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $allAttributes['objects'][0]->id?'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input onkeyup="value=value.replace(/[^0-9.]+/,'')" value="{{$goodsInfo[0]->price}}" type="text" id="price" name="price" required="" lay-verify="price" autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              <label class="layui-form-label"><span class="x-red">*</span>是否促销</label>
              <div class="layui-input-block">
                  <input id="yes" name="WDC" type="radio" lay-skin="primary" title="是" {{$goodsInfo[3][0]->status == 1?'checked':''}}>
                  <input name="WDC" type="radio" lay-skin="primary" title="否" {{$goodsInfo[3][0]->status == 2?'checked':''}}>
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input onkeyup="value=value.replace(/[^0-9]+]/,'')" type="number" min='0' value="{{$goodsInfo[2][0]->store}}" id="store" name="store" required="" lay-verify="store"
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="status" name="status" class="valid">
                    ...
                    <option value="{{$v->id}}" {{$v->id == $goodsInfo[0]->status ? 'selected':''}}>{{$v->name}}</option>
                    @endforeach
                  </select>
              </div>
              <div class="layui-input-inline">
          ...
          <div class="layui-form-item layui-form-text">
              ...
              <div class="layui-input-block">
                  <textarea placeholder="请输入内容" id="desc" name="desc" class="layui-textarea">{{$goodsInfo[1][0]->desc}}</textarea>
              </div>
          </div>
          <div class="layui-form-item">
    ...
    <script>
        ...
        WDC.val(function(){
                ...
                oto.empty();
                oto.append("<input onkeyup=\"value=value.replace(/[^0-9.]+/,'')\" type='text' value=\"{{$goodsInfo[3][0]->discount}}\" name='discount' class='layui-input'>");
             })
         });
