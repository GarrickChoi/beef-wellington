...
<html>
  ...
  <body>
    ...
    @endif
    <div class="x-body">
        <form  method="post" class="layui-form layui-form-pane" action="{{url('adminuserrole')}}">
            {{csrf_field()}}
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block layui-form-text">
                        @foreach($permission as $value)
                            <span>
                                <input name="permission[]" type="checkbox" value="{{$value->id}}" style="width:600px">　{{ $value->display_name }}
                            </span>
                            @if($value->id%4 == 0)
                             <br>
                            @endif    
