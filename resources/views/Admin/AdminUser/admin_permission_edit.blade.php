...
<html>
  ...
  <body>
    ...
    @endif
    <div class="x-body">
        <form  method="post" class="layui-form layui-form-pane" action="{{url('adminpermission/'.$permission->id)}}">
            ...
            {{ method_field('PUT') }}
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="name" value="{{$permission->name}}" required="" lay-verify="required"
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容" id="desc" name="description" class="layui-textarea" value="{{$permission->description}}">{{$permission->description}}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                <button class="layui-btn" lay-submit="" lay-filter="add">编辑</button>
                <a href="{{url('adminpermission')}}" class="layui-btn">返回</a>
            </div>
        </form>
    </div>
    <script>
